  ...
  return (
    <div className="space-y-4">
        ...
        <TableHeader>
            ...
            <TableHead>US Trade Name</TableHead>
            <TableHead>Initial Dose</TableHead>
            <TableHead>Usual Maintenance Dose</TableHead>
            <TableHead>Max Dose (Refractory Shock)</TableHead>
            </TableRow>
        </TableHeader>
        <TableBody>
